...
public class Casas {
    ...
    public Casas(int numerocasa, int bloque, String color, double ancho, double largo, String comprada, String nombre, int pisos, int baños, int cuartos, String estado, String ingeniero) {
